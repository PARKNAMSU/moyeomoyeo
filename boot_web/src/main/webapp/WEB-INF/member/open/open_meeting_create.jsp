		...
		<div class="div_01">
			...
			<div class="fl margin_left_50 div_01_01 sub_div">
				...
				<select class="form-control fl" style="width:49%;" onclick="setMaxPrice($(this).val())">
				  ...
				  -->
				<select class="form-control fl" style="width:49%;margin-right:10px;" id="category">
				</select>
			</div>
			<div class="clear"></div>
		</div>
...
<script>
	...
	const category = ["여행","동호회","계모임","비정기 모임","파티","회식"]
	chkWindowWidth()
	setDatePicker()
	setSelectNum()
	...
	function setSelectNum(){
		...
		for(var i=0; i<category.length; i++){
			var node = "<option value="+category[i]+">"+category[i]+"</option>"
