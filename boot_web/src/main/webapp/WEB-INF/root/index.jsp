...
<style>
	...
	#main_1{
		margin-top:85px;position:relative;z-index:1;
	}
	#main_1::after{
		background-image:url('/resource/img/index_bg.png');background-repeat:no-repeat;
		opacity:0.5;position:absolute;z-index:-1;content:"";top:0;left: 0;width:100%;height:100%;
